...
cron 15 * * * * https://raw.githubusercontent.com/Tersd07/st1/master/jd_dreamFactory.js
 */
...
function updateShareCodes(url = 'https://raw.githubusercontent.com/Tersd07/st1/master/jd_dreamFactory.js') {
...
function updateShareCodesCDN(url = 'https://cdn.jsdelivr.net/gh/Tersd07/st1@master/jd_dreamFactory.js') {
  return new Promise(resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
