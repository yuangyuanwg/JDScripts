...
main();
async function main() {
  $.http.get({url: `https://purge.jsdelivr.net/gh/MoPoQAQ/Script@main/Me/jx_cfd.js`}).then((resp) => {
...
function updateShareCodes(url = 'https://raw.githubusercontent.com/MoPoQAQ/Script/main/Me/jx_cfd.js') {
...
function updateShareCodesCDN(url = 'https://cdn.jsdelivr.net/gh/MoPoQAQ/Script@main/Me/jx_cfd.js') {
  return new Promise(resolve => {
    $.get({url}, async (err, resp, data) => {
      try {
        if (err) {
